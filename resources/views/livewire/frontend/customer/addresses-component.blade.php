    ...
    <form wire:submit.prevent="{{ $editMode ? 'update_address' : 'store_address' }}" x-show="formShow" @click.away="formShow = false">
        <div class="row">
            ...
            <div class="col-lg-8 form-group">
                <label for="address_title" class="text-small text-uppercase">Address Title</label>
                <input class="form-control" id="address_title" wire:model="address_title" type="text" placeholder="Enter your address title">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="first_name" id="first_name" type="text" placeholder="Enter your first name">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="email" id="last_name" type="email" placeholder="e.g. Jason@example.com">
                @error('email')<span class="text-danger">{{ $message }}</span>@enderror
            </div>

            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="mobile">Mobile number</label>
                <input class="form-control form-control-lg" wire:model="mobile" id="mobile" type="tel" placeholder="e.g. 966512345678">
                @error('mobile')<span class="text-danger">{{ $message }}</span>@enderror
            </div>

            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="address">address</label>
                <input class="form-control form-control-lg" wire:model="address" id="address" type="text" placeholder="Enter your first name">
                @error('address')<span class="text-danger">{{ $message }}</span>@enderror
            </div>

            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="address2">address2</label>
                <input class="form-control form-control-lg" wire:model="address2" id="address2" type="text" placeholder="Enter your last name">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" id="zip_code" wire:model="zip_code" type="text" placeholder="Enter your first name">
                @error('zip_code')<span class="text-danger">{{ $message }}</span>@enderror
            </div>

            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="po_box">P.O.Box</label>
                <input class="form-control form-control-lg" id="po_box" wire:model="po_box" type="text" placeholder="Enter your last name">
