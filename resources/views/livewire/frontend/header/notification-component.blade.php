<div>
    ...
    @forelse ($unreadNotifications as $notification)
            ...
            <div>
                ...
                <span class="font-weight-bold">Order {{ $notification->data['order_ref'] }} @if($notification->type == 'App\Notifications\Frontend\Customer\OrderThanksNotification') completed successfully @else  status is ({{ $notification->data['last_transaction'] }}) @endif</span>
            </div>
            </a>
