...
<div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.customer_addresses.update', $customer_address->id) }}" method="post" autocomplete="off">
                @csrf
                @method('PATCH')
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="user_id" id="user_id" value="{{ $customer_address->user_id }}"> 
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label for="address_title">Default Address</label>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="first_name" value="{{ old('first_name', $customer_address->first_name) }}"> 
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="last_name" value="{{ old('last_name', $customer_address->last_name) }}"> 
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="email" value="{{ old('email', $customer_address->email) }}"> 
