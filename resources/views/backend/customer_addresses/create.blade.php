...
<div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.customer_addresses.store') }}" method="post" autocomplete="off">
                @csrf
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control typeahead" name="customer_name" value="{{ old('customer_name') }}" id="customer_name" placeholder="Start typing something to search customer..." autocomplete="off"> 
                            <input type="hidden" class="form-control" name="user_id" id="user_id" value="{{ old('user_id') }}" readonly> 
