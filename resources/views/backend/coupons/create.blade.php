                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('code')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('type')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('value')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('use_times')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('start_date')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('expire_date')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @error('greater_than')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="summernote" class="form-control"rows="3">{{ old('description') }}</textarea>
                            @error('description')<span class="text-danger">{{ $messages }}</span>@enderror
                        </div>
                    </div>
                </div> 
