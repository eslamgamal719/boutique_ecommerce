...
class AddressesComponent extends Component
{
    ...
    public function update_address()
    {
        ...
        auth()->user()->addresses()->whereId($this->address_id)->update([
    ...
    public function render()
    {
        ...
        $this->states = $this->country_id != '' ? State::whereCountryId($this->country_id)->whereStatus(true)->get() : [];
        $this->cities = $this->state_id != '' ? City::whereStateId($this->state_id)->whereStatus(true)->get() : [];
